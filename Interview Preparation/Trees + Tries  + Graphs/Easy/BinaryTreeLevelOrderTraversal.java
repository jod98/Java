/*
    ...
    HELP: https://www.youtube.com/watch?v=gcR28Hc2TNQ&ab_channel=BackToBackSWE
          https://www.youtube.com/watch?v=XZnWETlZZ14&ab_channel=KevinNaughtonJr.
*/

class Solution {
    public List<List<Integer>> levelOrder(TreeNode root) {  // we use BFS (just like in graphs) to retrieve level order traversal of binary tree. Return a list of lists containing the node values at each level of the tree
